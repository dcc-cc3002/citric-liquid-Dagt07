...
class AbstractPanelTest extends munit.FunSuite{
  ...
  */
  ...
  test("A AbstractPanel should have correctly set their attributes") {
  ...
  // 2. Test methods
  test("A AbstractPanel should add a character to the list of characters currently on this panel") {
  ...
  test("A AbstractPanel should remove a character to the list of characters currently on this panel") {
    assertEquals(abstractpanel.characters, ArrayBuffer[PlayerCharacter](player1, player2, player3))
